...
def generate_model_output(
    ...
    output = ModelOutput(
        match_id=match.id,
        our_home_prob=predictions.home_win,
        our_draw_prob=predictions.draw,
        our_away_prob=predictions.away_win,
        our_home_odds=predictions.home_fair_odds,
        our_draw_odds=predictions.draw_fair_odds,
        our_away_odds=predictions.away_fair_odds,
        market_home_odds=match.odds_home,
        market_draw_odds=match.odds_draw,
        market_away_odds=match.odds_away,
        home_edge_pct=home_edge,
        draw_edge_pct=draw_edge,
        away_edge_pct=away_edge,
        best_value_outcome=best_value,
        confidence_rating=predictions.confidence,
